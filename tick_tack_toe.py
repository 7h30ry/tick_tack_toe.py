...
def btnClick(buttons):
    ...
    if buttons['text'] == ' ' and bclick == True:
        ...
        tkinter.messagebox.showinfo('Tic-Tac-Toe', 'Butoon already clicked')
...
def checkForWin():
    if (button1['text'] == 'X' and button2['text'] == 'X' and button3['text'] == 'X' or
        ...
        tkinter.messagebox.showinfo('Tick-Tac-Toe', pa)
    

    elif(flag == 8):
        tkinter.messagebox.showinfo('Tick-Tac-Toe', 'It a tie')
...
label2 = Label(tk, text='Player2:', font=('Times',20,'bold'), bg ='white', fg='black', height=1, width=8)
